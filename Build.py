...
if __name__ == "__main__":
	...
	if (len(sys.argv) > 1) and (sys.argv[1].lower() == "clean"):
		clean_dir_list = [ "7z", "android_native_app_glue", "assimp", "cxxopts", "d3dcompiler", "dxsdk", "filesystem", "fmt", "FreeImage", "freetype", "googletest", "GSL", "libogg", "libvorbis", "nanosvg", "openal-soft", "optional-lite", "Python", "python-cmake-buildsystem", "rapidjson", "rapidxml", "string-view-lite", "wpftoolkit", "zlib", "glslang", "SPIRV-Cross" ]

...
#ifndef KLAYGE_PLUGINS_VULKAN_MAPPING_HPP
#define KLAYGE_PLUGINS_VULKAN_MAPPING_HPP
...
namespace KlayGE
{
	...
	public:
		...
		static VkFormat MappingFormat(ElementFormat pf);
		// static ElementFormat MappingFormat(DXGI_FORMAT d3dfmt);
	};
}

#endif			// KLAYGE_PLUGINS_VULKAN_MAPPING_HPP

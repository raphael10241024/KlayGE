...
#ifndef KLAYGE_PLUGINS_VULKAN_RENDER_ENGINE_HPP
#define KLAYGE_PLUGINS_VULKAN_RENDER_ENGINE_HPP
...
namespace KlayGE
{
	...
	public:
		...
		inline VkCommandBuffer CurCommandBuffer() const
		{
			return drawCommandBuffers_[cur_image_index_];
		}
		...
		VulkanDevicePtr GetVulkanDevicePtr() const;
	...
	private:
		...
		uint32_t cur_image_index_;
	};
}

#endif			// KLAYGE_PLUGINS_VULKAN_RENDER_ENGINE_HPP

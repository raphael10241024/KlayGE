/**
 * @file VulkanRenderFactoryInternal.hpp
 * @author Minmin Gong
 *
 * @section DESCRIPTION
 *
...
#ifndef KLAYGE_PLUGINS_VULKAN_RENDER_FACTORY_HPP
#define KLAYGE_PLUGINS_VULKAN_RENDER_FACTORY_HPP
...
namespace KlayGE
{
	class VulkanRenderFactory final : public RenderFactory
	{
	public:
		VulkanRenderFactory();
	...
	private:
		...
		VulkanDevicePtr GetVulkanDevicePtr();
	private:
		VulkanRenderFactory(VulkanRenderFactory const & rhs);
		VulkanRenderFactory& operator=(VulkanRenderFactory const & rhs);
	};
}

#endif			// KLAYGE_PLUGINS_VULKAN_RENDER_FACTORY_HPP
